...
public class WhopperCrawling {
    ...
    @Transactional
    List<Whopper> getDataList() throws InterruptedException {
        ...
        List<Whopper> whoppers = new ArrayList<>(elements.size());
