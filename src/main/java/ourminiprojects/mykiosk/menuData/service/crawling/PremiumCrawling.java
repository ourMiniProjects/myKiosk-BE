...
import ourminiprojects.mykiosk.menuData.repository.PremiumRepository;
...
public class PremiumCrawling {
    private WebDriver driver;
    private final PremiumRepository whopperRepository;
    ...
    @Transactional
    List<Premium> getDataList() throws InterruptedException {
        ...
        // 신제품(NEW)을 클릭합니다.
        WebElement newProductButton = driver.findElement(By.cssSelector(".GNBWrap > ul > li:first-child > ul > li:nth-child(2) > a"));
        ...
        List<Premium> whoppers = new ArrayList<>(elements.size());

        System.out.println("whopper생성" + elements.size());

        int[] priceArr = {7200,7400,8200,8300};
