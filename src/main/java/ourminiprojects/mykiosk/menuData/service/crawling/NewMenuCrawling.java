...
import ourminiprojects.mykiosk.menuData.repository.NewMenuRepository;
...
public class NewMenuCrawling {
    private WebDriver driver;
    private final NewMenuRepository whopperRepository;
    ...
    @Transactional
    List<NewMenu> getDataList() throws InterruptedException {
        ...
        // 신제품(NEW)을 클릭합니다.
        WebElement newProductButton = driver.findElement(By.cssSelector(".GNBWrap > ul > li:first-child > ul > li:first-child > a"));
        ...
        List<NewMenu> whoppers = new ArrayList<>(elements.size());
