...
import ourminiprojects.mykiosk.menuData.repository.MorningRepository;
...
public class MorningCrawling {
    private WebDriver driver;
    private final MorningRepository whopperRepository;
    ...
    @Transactional
    List<Morning> getDataList() throws InterruptedException {
        ...
        // 신제품(NEW)을 클릭합니다.
        WebElement newProductButton = driver.findElement(By.cssSelector(".GNBWrap > ul > li:first-child > ul > li:nth-child(5) > a"));
        ...
        List<Morning> whoppers = new ArrayList<>(elements.size());

        System.out.println("whopper생성" + elements.size());

        int[] priceArr = {4900, 5200, 4500, 4300, 5400,4100};
