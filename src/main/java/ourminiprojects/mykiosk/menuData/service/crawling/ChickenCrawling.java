...
import ourminiprojects.mykiosk.menuData.repository.ChickenRepository;
...
public class ChickenCrawling {
    private WebDriver driver;
    private final ChickenRepository whopperRepository;
    ...
    @Transactional
    List<Chicken> getDataList() throws InterruptedException {
        ...
        // 신제품(NEW)을 클릭합니다.
        WebElement newProductButton = driver.findElement(By.cssSelector(".GNBWrap > ul > li:first-child > ul > li:nth-child(4) > a"));
        ...
        List<Chicken> whoppers = new ArrayList<>(elements.size());

        System.out.println("whopper생성" + elements.size());

        int[] priceArr = {4900, 5200, 4500, 4300, 6100, 7200, 5900, 6900, 4800, 5700};
